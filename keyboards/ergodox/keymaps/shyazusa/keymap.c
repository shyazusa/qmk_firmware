 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Alt  |   |  |AltShf|  Up  | Down |                                       | Left | Down |  UP  |Right | Enter|
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,--------------.       ,-------------.
 *                                        | Play  | Next |       | VolD | VolU |
 *                                ,-------|-------|------|       |------+------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        LCTL(KC_LEFT), KC_Z,    KC_X,          KC_C,  KC_V,    KC_B,    TG(1),
        KC_LALT,       KC_PIPE, LALT(KC_LSFT), KC_UP, KC_DOWN,
                                                               KC_MPLY, KC_MNXT,
                                                                        KC_ENT,
        ...
        TG(2),   KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH,  LCTL(KC_RIGHT),
 ...
 * |--------+-------+-------+------+------+-------|      |           |      |------+------+------+------+-------+--------|
 * | Ctrl+L |GuiAltL|MsLeft |MsDown|MsRght|       |------|           |------| Left | Down |  Up  | Right|GuiAltR| Ctrl+R |
 * |--------+-------+-------+------+------+-------|      |           |      |------+------+------+------+-------+--------|
 * |        |       |  BS   |      |      |       |      |           |      |      |      |WhDown|      |       |        |
 * `--------+-------+-------+------+------+--------------'           `-------------+------+------+------+-------+--------'
 *   |      |       |       | Lclk | Rclk |                                       |      |      |      |       |      |
...
[MDIA] = KEYMAP(
        ...
        LCTL(KC_LEFT), G_A(KC_LEFT), KC_MS_L,    KC_MS_D, KC_MS_R, KC_TRNS,
        ...
        KC_TRNS,  LGUI(KC_C), KC_BTN1, KC_WH_U, KC_BTN2,  LGUI(KC_V),    KC_TRNS,
                  KC_LEFT,    KC_DOWN, KC_UP,   KC_RIGHT, G_A(KC_RIGHT), LCTL(KC_RIGHT),
        KC_TRNS,  KC_TRNS,    KC_TRNS, KC_WH_D, KC_TRNS,  KC_TRNS,       KC_TRNS,
                              KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,       KC_TRNS,
        KC_TRNS, KC_TRNS,
        KC_TRNS,
        KC_WBAK, KC_BTN1, KC_TRNS
),
};
